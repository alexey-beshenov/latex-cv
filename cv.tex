...
\begin{itemize}
\item \textbf{\biling{March}{Marzo de} 2021}:
  \biling{Number theory seminar}{Seminario de la teoría de números} UAM-ICMAT,
  Madrid (\biling{online}{en línea}).
...
{\color{RoyalBlue}\section*{\biling{MATHEMATICAL WRITING}{TEXTOS MATEMÁTICOS}}}
